...
import InvitationEmail from '@wiki/transactional/emails/invitation-email';
import { GroupUserRepo } from '@wiki/db/repos/group/group-user.repo';
import InvitationAcceptedEmail from '@wiki/transactional/emails/invitation-accepted-email';
...
export class WorkspaceInvitationService {
  ...
  async acceptInvitation(
    ...
    if (invitedByUser) {
      ...
      await this.mailService.sendToQueue({
        ...
        subject: `${newUser.name} has accepted your wiki invite`,
  ...
  async sendInvitationMail(
    ...
    await this.mailService.sendToQueue({
      to: inviteeEmail,
      subject: `${invitedByName} invited you to Wiki`,
      template: emailTemplate,
    });
  }
}
